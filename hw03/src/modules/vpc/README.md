...
| Name | Description |
|------|-------------|
| <a name="output_network_id"></a> [network_id](#output_network_id) | ID созданной сети VPC |
| <a name="output_network_name"></a> [network_name](#output_network_name) | Имя созданной сети VPC |
| <a name="output_subnet_id"></a> [subnet_id](#output_subnet_id) | ID созданной подсети |
| <a name="output_subnet_name"></a> [subnet_name](#output_subnet_name) | Имя созданной подсети |
<!-- END_TF_DOCS -->
