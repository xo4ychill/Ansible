...
## Подготовка к выполнению
 ...
 - Подготовка в Yandex Cloud трёх хостов:  `clickhouse`,  `vector` и  `lighthouse`.
Для развертывания используется `Terraform`.
[Инфраструктура](docs/DIRECTORY_STRUCTURE.md)
